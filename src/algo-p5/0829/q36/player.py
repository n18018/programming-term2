    ...
    def battle(self, enemy):
        ...
        while enemy.hp > 0:
            ...
            if enemy.__class__.__name__ == "BossChara":
                # ボスキャラの場合(enemy.__class__.__name__ == "BossChara")、
                # 変数cmd_guideに、"1:攻撃する、3:薬草を使う>> "を代入する。
            ...
            cmd_guide = input("1:攻撃する、3:薬草を使う、9:逃げる>> ")
            ...
            if cmd_guide == "1":
                ...
                # 薬草を使う
                self.use_plants()
            elif cmd_guide == "9" and enemy.__class__.__name__ != "BossChara":
                # 直前の行の条件(elif句)に、enemy.__class__.__name__ !=
                # "BossChara"をand条件として追加してください。(ボス戦では逃げられない)
                # 逃げる
        ...
        # 経験値を獲得
        # ボスキャラ戦以外の場合(enemy.__class__.__name__ != "BossChara")
        # のみself.get_exp()を呼び出してください。
        if enemy.__class__.__name__ != "BossChara":
            self.get_exp()
