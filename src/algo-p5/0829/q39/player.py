...
class Player:
    ...
    def battle(self, enemy):
        ...
        if enemy.__class__.__name__ == "BossChara":
            ...
            cmd_guide = "1:攻撃する、3:薬草を使う (これら以外を入力した場合は待機する) >> "
        else:
            # ボスキャラ以外の場合、逃げることが可能
            cmd_guide = "1:攻撃する、3:薬草を使う、9:逃げる (これら以外を入力した場合は待機する) >> "
    ...
    def pick_up_plant(self):
        ...
        print(self.name, "は薬草を手に入れた!現在薬草を", self.plant_nums, "枚持っています。")
